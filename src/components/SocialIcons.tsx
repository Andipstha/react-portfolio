  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/andipstha" target="_blank">
            <FaGithub />
          </a>
        </span>
        <span>
        ...
        <span>
          <a href="https://x.com/andipstha" target="_blank">
            <FaXTwitter />
          </a>
        </span>
        <span>
          <a href="https://www.instagram.com/andipstha" target="_blank">
            <FaInstagram />
          </a>
        </span>
      </div>
      <a className="resume-button" href="https://www.sandipshrestha0.com.np/files/myResume-SandipShrestha.pdf" target="_blank">
